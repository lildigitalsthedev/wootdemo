...
/**
 * The buying experience: browse/search products across every business,
 * favorite categories/products, and manage the shared cart. Used by
 * customers on /customer/shop, and by business owners on /dashboard/shop
 * when they're in "Marketplace" mode rather than managing their own store.
 */
