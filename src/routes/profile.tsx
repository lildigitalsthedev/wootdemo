...
function ProfilePage() {
  ...
  const identityCard = (compact: boolean) => (
    <div className={compact ? "flex flex-col items-center text-center" : "flex flex-col items-center text-center"}>
      <motion.button
        type="button"
      ...
      <div className="mt-3 flex items-center gap-1.5">
        <span className="text-[20px] font-black tracking-tight">{me.name}</span>
      ...
      <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col pb-28 md:max-w-none lg:min-h-0 lg:pb-0">
        <PageTransition>
          <div className="mx-auto min-h-[100dvh] w-full max-w-3xl bg-surface md:max-w-none lg:flex lg:h-[100dvh] lg:min-h-0 lg:max-w-none">
            {/* Mobile / tablet: single stacked column, unchanged experience */}
            <div className="lg:hidden">
              ...
              <div className="px-4 pt-6 md:mx-auto md:max-w-xl">
                {identityCard(false)}
                <div className="mt-6">{quickAccessContent}</div>
                <div className="mt-6">{storefrontContent}</div>
                <div className="h-12" />
              </div>
            </div>

            {/* Desktop / tablet master-detail: identity + section nav, detail panel */}
